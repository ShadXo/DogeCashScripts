...
for FILE in ~/bin/${NAME}d_$PARAM1.sh; do
  ...
  do
	...
	#BLOCKCOUNTCOINEXPLORERDOGECASH=${array[8]}
	# echo $BLOCKCOUNTCOINEXPLORERDOGECASH
	#BLOCKCOUNTCOINEXPLORERDOGECASH=$(echo $BLOCKCOUNTCOINEXPLORERDOGECASH | tr , " ")
	# echo $BLOCKCOUNTCOINEXPLORERDOGECASH
	#BLOCKCOUNTCOINEXPLORERDOGECASH=$(echo $BLOCKCOUNTCOINEXPLORERDOGECASH | tr '"' " ")
	# echo $BLOCKCOUNTCOINEXPLORERDOGECASH
	# echo -e "BLOCKCOUNTCOINEXPLORERDOGECASH='${BLOCKCOUNTCOINEXPLORERDOGECASH}'"
	#BLOCKCOUNTCOINEXPLORERDOGECASH="$(echo -e "${BLOCKCOUNTCOINEXPLORERDOGECASH}" | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//')"
	# echo -e "BLOCKCOUNTCOINEXPLORERDOGECASH='${BLOCKCOUNTCOINEXPLORERDOGECASH}'"
	...
	# echo $BLOCKHASHCOINEXPLORERDOGECASH
	#BLOCKHASHCOINEXPLORERDOGECASH=$(echo $BLOCKHASHCOINEXPLORERDOGECASH | tr '"' " ")
	# echo $BLOCKHASHCOINEXPLORERDOGECASH
	# echo -e "BLOCKHASHCOINEXPLORERDOGECASH='${BLOCKHASHCOINEXPLORERDOGECASH}'"
